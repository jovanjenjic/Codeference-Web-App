...
function AdjacentPostCard({ post, position }) {
  return (
    <>
      ...
      {position === "LEFT" && (
        <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-sky-500 left-4 rounded-full">
          <svg
      ...
      {position === "RIGHT" && (
        <div className="absolute arrow-btn bottom-5 text-center py-3 cursor-pointer bg-sky-500 right-4 rounded-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6 text-white w-full mx-auto"
            fill="none"
