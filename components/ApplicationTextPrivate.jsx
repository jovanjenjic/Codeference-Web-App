...
function ApplicationText({ showSuccessMessage, showErrorMessage }) {
  return (
    <div className="text-gray-600 justify-between flex flex-col relative lg:pr-4 pb-10 lg:pb-0">
      ...
      <div>
        <b className="text-xl">Prijava za privatan smeštaj</b>
        <br /> <br />
        <br />
        ...
        <div>
          <br />
          Cena koja uključuje prevoz, smeštaj (opciono sa hranom), kotizacije i
          poklon materijale: <br /> <br />
          <span className="text-red-600">*</span> Hrana podrazumeva polupansion
          - doručak i večeru <br /> <br />
          <span className="text-red-600">*</span> Svi apartmani su trokrevetni i
          četverokrevetni <br /> <br />
